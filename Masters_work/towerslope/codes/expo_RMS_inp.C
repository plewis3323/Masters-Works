...
void Mill_Mean_input(TCanvas* Inputs1) {
    Inputs1->cd(); 
    const int n = 3; 
    double std1a[3] = {0.0133, 0.02027, 0.02753};
    double std1b[3] = {0.01287, 0.01934, 0.08351};
    double std5a[3] = {0.005219, 0.009144, 0.02904};
    double std5b[3] = {0.004291, 0.00443, 0.007866};
    double std10a[3] = {0.004665, 0.005321, 0.008393};
    double std10b[3] = {0.003019, 0.005956, 0.003956};
    double std100a[3] = {0.001237, 0.001134, 0.003294};
    ...
    TFile *Mean_inp = new TFile("expo_events_RMS_inp.root", "RECREATE");
