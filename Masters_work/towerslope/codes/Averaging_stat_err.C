...
void process_p1_series() {
    ...
    TString directory = "/home/plewis/Master_w/Masters_work/towerslope/Exp/Exp_data"; // Update this path with your directory
    TString filepath = TString::Format("%s/E_p1_100millH_measurement.txt", directory.Data()); // Replace with your filename if needed
    ...
    if (p1_values.size() < 48) { // Ensure at least 96 values (16 measurements for 6 series)
