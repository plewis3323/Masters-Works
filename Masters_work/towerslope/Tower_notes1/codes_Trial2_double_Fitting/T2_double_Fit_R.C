...
void testslope(int stats, double shift_factor, string f_1, string f_2) {
    ...
    for (int k = 0; k < 16; k++) {
        ...
        c1->Clear(); // Clear the canvas before drawing the next histogram
...
void Run_1() {
  ...
  testslope(7e5, 0.7, "R_Trial_1","R_Tally_1");
  testslope(7e5, 1.0, "R_Trial_2","R_Tally_2");
  testslope(7e5, 1.3, "R_Trial_3","R_Tally_3");
