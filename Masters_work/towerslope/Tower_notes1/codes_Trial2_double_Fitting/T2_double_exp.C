...
void testslope_ExpDf(int stats, double shift_factor, string f_1, string f_2) {   
...
void Run_1()  {
    ...
    testslope_ExpDf(7e5, 0.7, " Exp_Trial_1", " Exp_tally_1"); 
    testslope_ExpDf(7e5, 1.0, " Exp_Trial_2", " Exp_tally_2");
     testslope_ExpDf(7e5, 1.3, " Exp_Trial_3", " Exp_tally_3");
