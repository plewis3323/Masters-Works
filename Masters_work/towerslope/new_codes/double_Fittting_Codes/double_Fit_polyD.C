...
void Run1() {
    tower_PolyDecay(7e6,  0.7,  "Pol_trials_1",  "Pol_tally_trials_1");
    tower_PolyDecay(7e6,  1.0,  "Pol_trials_2",  "Pol_tally_trials_2");
    tower_PolyDecay(7e6,  1.3,  "Pol_trials_3",  "Pol_tally_trials_3");
}
