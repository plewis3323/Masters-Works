...
void tower_PolyDecay(int stats, double sf, string f_1) {
     string f_e = ".png";
...
void Run1() {
    tower_PolyDecay(7e6,  0.7,  "Log_poly1");
	tower_PolyDecay(7e6,  1.0,  "Log_poly2");
	tower_PolyDecay(7e6,  1.3,  "Log_poly3");
}
