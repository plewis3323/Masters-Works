...
void testslope_ExpDf(int stats, double shift_factor, string f_1)             {
...
testslope_ExpDf(7e6, 0.7, "Log_exp_1");
testslope_ExpDf(7e6, 1.0, "Log_exp_2");
testslope_ExpDf(7e6, 1.3, "Log_exp_3");
